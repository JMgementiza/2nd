  ...
  <body>
    ...
    <aside id="sidebar" class="sidebar">
      ...
      <ul class="sidebar-nav" id="sidebar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link collapsed" href="../patient-registration/register.php " style="color: #57d8cd;">
    ...
    <main id="main" class="main">
      ...
      <!-- Add Patient Modal -->
      <div class="modal-container d-flex justify-content-end">
            ...
            <div class="modal-dialog modal-lg">
              <div class="modal-content"> 
                ...
                <div class="modal-header">
                  <h5 class="modal-title"><b>INSERT PATIENT DATA</b></h5>
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>

                <div class="modal-body">

                  <form action="../includes/registration.inc.php" method="POST" class="row g-3">
                    <div class="col-md-4">
        ...
        <div class="modal fade" id="viewPatientModal" tabindex="-1">
            <div class="modal-dialog modal-lg">
              <div class="modal-content"> 
                ...
                <div class="modal-header">
                  <h5 class="modal-title"><b>View Patient Information</b></h5>
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>

                <div class="modal-body">

                  <form action="../includes/patient-update.inc.php" method="POST" class="row g-3"  id="viewRegistrationForm">
        ...
        <div class="modal fade" id="editPatientModal" tabindex="-1">
            <div class="modal-dialog modal-lg">
              <div class="modal-content"> 
                ...
                <div class="modal-header">
                  <h5 class="modal-title"><b>EDIT PATIENT DATA</b></h5>
                  <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>

                <div class="modal-body">

                  <form action="../includes/patient-update.inc.php" method="POST" class="row g-3"  id="editRegistrationForm">
        ...
        </div><!-- End Update Patient Modal-->

        <?php
          include '../includes/patient-pagination.inc.php';
        ?>
        ...
        <div class="col-12">
              <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                  <h5 class="card-title">List of Patients <span>| Today</span></h5>
                                  ...
                                  if (mysqli_num_rows($query_run) > 0)
                                  {
                                      foreach($query_run as $patient)
                                      {
                                          ...
                                          <tr>
                                              ...
                                              <td>
                                                  <a href="../includes/patient-view.php?view=<?=$patient['patient_id'];?>" type="button" class="btn btn-primary edit-link" data-bs-toggle="modal" data-bs-target="#viewPatientModal">
                                                    View
                                                  </a>
                                                  <a href="../includes/patient-edit.php?edit=<?=$patient['patient_id'];?>" type="button" class="btn btn-primary edit-link" data-bs-toggle="modal" data-bs-target="#editPatientModal">
                                                    Edit
                                                  </a>
